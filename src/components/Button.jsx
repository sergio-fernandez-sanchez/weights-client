export default function Button({ children, onClick, type = 'button', disabled = false, variant = 'primary' }) {
  const base = 'h-14 font-mono font-bold text-base tracking-widest transition-all duration-200 disabled:opacity-50 w-full hover-lift click-press'
  const variants = {
    primary:   'bg-[#c8f500] text-[#0a0a0a] border border-[#c8f500] hover:bg-[#0a0a0a] hover:text-[#c8f500] btn-glow',
    secondary: 'bg-[#141414] text-[#e8e8e8] border border-[#333333] hover:bg-[#1f1f1f] hover:border-[#c8f500] text-left px-6',

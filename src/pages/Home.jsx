        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="text-left">
              ...
              <p className="text-[#41434a] font-sans text-xs font-bold">{fmtWeekFromISO(lastMondayISO)}</p>
            </div>
          </div>
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <div className="relative">
            <input
              ...
              placeholder="00.00"
              required
              className="w-full input-frosted rounded-sm h-14 px-4 pr-12 font-mono text-xl font-bold text-[#41434a] outline-none"
